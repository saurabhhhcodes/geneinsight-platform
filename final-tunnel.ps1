...
try {
    ...
    $publicIP = "Unable to detect - check whatismyipaddress.com"
...
if (-not ($frontendOK -or $backendOK -or $mlServiceOK)) {
    Write-Host "No services running! Start with: docker-compose up" -ForegroundColor Red
    exit
}
...
Write-Host "Creating tunnels..." -ForegroundColor Yellow
...
Write-Host "Share these URLs with your friend:" -ForegroundColor Cyan
foreach ($url in $tunnelUrls) {
    Write-Host "   $url" -ForegroundColor White
}

if ($frontendOK) {
    Write-Host "MAIN APP URL FOR YOUR FRIEND:" -ForegroundColor Yellow
    Write-Host "   $frontendUrl" -ForegroundColor Green
}

Write-Host "PASSWORD FOR YOUR FRIEND:" -ForegroundColor Yellow
Write-Host "===========================================" -ForegroundColor Yellow
Write-Host "PASSWORD: $publicIP" -ForegroundColor Green
Write-Host "===========================================" -ForegroundColor Yellow

Write-Host "Instructions to send to your friend:" -ForegroundColor Cyan
...
Write-Host "Copy this message and send to your friend:" -ForegroundColor Cyan
...
Write-Host "Tunnels are active. Press Ctrl+C to stop." -ForegroundColor Green
